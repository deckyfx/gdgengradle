...
public abstract class ToManyBase extends RelationBase {
    @SuppressWarnings("unused")
    private final Schema schema;
    private String name;
    protected final Entity sourceEntity;
    protected final Entity targetEntity;
    private final com.github.deckyfx.gdgengradle.generator.PropertyOrderList propertyOrderList;

    public ToManyBase(Schema schema, Entity sourceEntity, Entity targetEntity) {
        this.schema = schema;
        this.sourceEntity = sourceEntity;
        this.targetEntity = targetEntity;
        propertyOrderList = new com.github.deckyfx.gdgengradle.generator.PropertyOrderList();
    }
