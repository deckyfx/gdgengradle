...
public class ToOne extends RelationBase {
    private final Schema schema;
    private final com.github.deckyfx.gdgengradle.generator.Entity sourceEntity;
    private final com.github.deckyfx.gdgengradle.generator.Entity targetEntity;
    private final com.github.deckyfx.gdgengradle.generator.Property[] fkProperties;
    private final String[] resolvedKeyJavaType;
    private final boolean[] resolvedKeyUseEquals;
    private String name;
    private final boolean useFkProperty;

    public ToOne(Schema schema, com.github.deckyfx.gdgengradle.generator.Entity sourceEntity, com.github.deckyfx.gdgengradle.generator.Entity targetEntity, com.github.deckyfx.gdgengradle.generator.Property[] fkProperties, boolean useFkProperty) {
        this.schema = schema;
    ...
    public com.github.deckyfx.gdgengradle.generator.Entity getSourceEntity() {
        return sourceEntity;
    }

    public com.github.deckyfx.gdgengradle.generator.Entity getTargetEntity() {
        return targetEntity;
    }

    public com.github.deckyfx.gdgengradle.generator.Property[] getFkProperties() {
        return fkProperties;
    }
    ...
    void init3ndPass() {
        ...
        com.github.deckyfx.gdgengradle.generator.Property targetPkProperty = targetEntity.getPkProperty();
        ...
        com.github.deckyfx.gdgengradle.generator.Property property = fkProperties[0];
        com.github.deckyfx.gdgengradle.generator.PropertyType propertyType = property.getPropertyType();
    ...
    protected boolean checkUseEquals(com.github.deckyfx.gdgengradle.generator.PropertyType propertyType) {
        boolean useEquals;
        switch (propertyType) {
        case Byte:
        case Short:
