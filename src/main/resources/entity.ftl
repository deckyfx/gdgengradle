...
<#elseif property.index??>
    ...
    private ${property.javaTypeInEntity} ${property.propertyName}<#if property.propertyDefaultValue??> = ${property.propertyDefaultValue}<#else></#if>;
</#list>
...
<#if toOne.javaDocField ??>
    ${toOne.javaDocField}
</#if>
<#if toOne.codeBeforeField ??>
    ${toOne.codeBeforeField}
</#if>
...
<#if toMany.javaDocField ??>
    ${toMany.javaDocField}
</#if>
<#if toMany.codeBeforeField ??>
    ${toMany.codeBeforeField}
</#if>
...
<#if toOne.javaDocGetter ??>
    ${toOne.javaDocGetter}
</#if>
<#if toOne.codeBeforeGetter ??>
    ${toOne.codeBeforeGetter}
</#if>
    @Generated
...
<#if toOne.javaDocSetter ??>
    ${toOne.javaDocSetter}
</#if>
<#if toOne.codeBeforeSetter ??>
    ${toOne.codeBeforeSetter}
</#if>
    @Generated
...
<#if toMany.javaDocGetter ??>
    ${toMany.javaDocGetter}
</#if>
<#if toMany.codeBeforeGetter ??>
    ${toMany.codeBeforeGetter}
</#if>
    @Generated
